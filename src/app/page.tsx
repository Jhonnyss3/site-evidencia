    ...
    <>
      ...
      >
        <div className="relative z-10 w-full max-w-[1200px] px-8 pb-16 flex flex-col items-center text-center">
          ...
          <a href="#contact" className={ctaButton} style={{ overflow: "hidden" }}>
            Fale Conosco
          </a>
        </div>
      </section>
        ...
        <div className="max-w-[900px] mx-auto px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-[#1a2b3f] text-base font-normal">Sim! Atendemos clientes de toda a região e também de outros estados, com atendimento digital e presencial.</p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-[#da412c] text-xl font-bold mb-2">Qual o prazo para abertura de empresa?</h3>
              <p className="text-[#1a2b3f] text-base font-normal">O prazo varia conforme o tipo de empresa e documentação, mas geralmente fica entre 15 a 30 dias úteis.</p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-[#da412c] text-xl font-bold mb-2">Fazem planejamento tributário?</h3>
              <p className="text-[#1a2b3f] text-base font-normal">Sim! Análise completa e estratégia para redução legal de impostos.</p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-[#da412c] text-xl font-bold mb-2">Como é feito o acompanhamento mensal?</h3>
              <p className="text-[#1a2b3f] text-base font-normal">Relatórios mensais, reuniões de acompanhamento e atendimento via WhatsApp/telefone.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex justify-center mb-12">
            <div className="max-w-[250px] bg-[#f8f9fa] rounded-lg p-8 shadow-md text-center">
              <div className="w-[200px] h-[200px] bg-[#f0f0f0] rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                <img src="/marcelo_logo.png" alt="Contador Responsável" className="w-full h-full object-cover" style={{ maxWidth: 200, maxHeight: 200 }} />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(9)].map((_, i) => (
              <div className="max-w-[250px] bg-[#f8f9fa] rounded-lg p-8 shadow-md text-center mx-auto" key={i}>
                <div className="w-[200px] h-[200px] bg-[#f0f0f0] rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                  {i === 0 ? (
                    <img src="/fabio_logo.png" alt="Fábio - Equipe" className="w-full h-full object-cover" style={{ maxWidth: 200, maxHeight: 200 }} />
                  ) : (
                    <span className="text-[#666] text-base font-medium">[FOTO 200x200px]</span>
                  )}
                </div>
                <h3 className="font-bold mb-2 text-[#1a2b3f]">{i === 0 ? "Fábio Silva" : `Nome ${i + 1}`}</h3>
                <p className="text-gray-600 font-normal">{i === 0 ? "Diretor Financeiro" : "Cargo"}</p>
              </div>
            ))}
          </div>
        </div>
