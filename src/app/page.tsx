        ...
        <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <div className="flex flex-col items-center gap-2 opacity-0 [.animate-contact_&]:animate-[fadeInUp_1s_ease-out_0.6s_forwards]">
              ...
              <a href="tel:+5524974012116" className="text-sm text-gray-600 hover:text-[#da412c] transition-colors">(24) 97401-2116</a>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 opacity-0 [.animate-contact_&]:animate-[fadeInUp_1s_ease-out_0.7s_forwards]">
              ...
              <a href="mailto:contato@evidenciaassessoria.com.br" className="text-sm text-gray-600 hover:text-[#da412c] transition-colors">contato@evidenciaassessoria.com.br</a>
            </div>
          </div>
